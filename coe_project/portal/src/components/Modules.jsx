...
const phase1 = [
  ...
  },
  {
    ...
    detail: `We start with three elements: Task, Context, Format. You give Gemini something to do, the background it needs, and the format you want back. We demonstrate this live on a real Vopak task — and the output is already good.\n\nThen comes the upgrade. We add one element: Persona.\n\nSame Task. Same Context. Same Format. We run the prompt twice — once for a terminal operator who has never used AI, once for a Finance analyst who lives in Excel. The output is completely different. Not because Gemini knows more — but because it now knows who it is talking to.\n\nThat moment of comparison is when PTCF clicks. By the end of the session, every participant has written one PTCF prompt for their own real work and tested it.`,

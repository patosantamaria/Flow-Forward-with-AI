...
### Training Support Gems

| Gem                    | What it does                                               |
| :--------------------- | :--------------------------------------------------------- |
| **Slide Deck Creator** | Builds structured slide outlines from raw training content |
| **Gem Architect**      | Writes System Instructions for new Gems — the meta-Gem     |

📄 **[Training Support Gems →](docs/gems/training_support_gems.md)**
...
| Resource                  | Link                                                                                                                                   |
| :------------------------ | :------------------------------------------------------------------------------------------------------------------------------------- |
| **Toolkit Google Sheet**  | [Gems, Departmental Examples & Participants](https://docs.google.com/spreadsheets/d/1DTlReZWzQ72tpBXlg_P7JhUQ0SCsHAtHmbg3FPBxCr0/edit) |
| **Google Drive (Shared)** | [Flow Forward Shared Folder](https://drive.google.com/drive/folders/1dSxVMMX2oFBAmyJ-WN5n4y_SLCt6I1wT)                                 |
| **Cloud Skills Boost**    | [Gemini for Workspace Training](https://www.cloudskillsboost.google/)                                                                  |
...
**Built by Patricio Santamaria · Google Consultant & Lead Trainer**
_In partnership with Martijn Sleijffers · Vopak AME BU_

_"The goal isn't using Gemini. The goal is Skill Expansion — doing things that were impossible before."_

...
HR needs a reskilling plan and ethical AI guidelines **by the end of this session**.
...
> **Prompt:** "Research best practices for AI reskilling programs in industrial organizations. Identify: (1) the most effective training formats for non-technical staff, (2) common resistance points and how to address them, (3) metrics to measure reskilling success. Present as a structured brief."
...
Create a 3-minute change management communication video script for the CEO.
...
1. 6-month Workforce Reskilling Plan
2. Ethical AI Guidelines for Recruitment & Performance
